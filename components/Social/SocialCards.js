        ...
        <a href="https://www.instagram.com/vanila.design/" target="_blank">
          <div className="socialCardInner socialBoxReveal">
            <img
              ...
              src={'/img/homeAssets/social-vaniladesign.webp'}
            />
      ...
      <li className="col-md-2">
        <a href="https://www.instagram.com/ui__ux/" target="_blank">
          <div className="socialCardInner socialBoxReveal">
            <img
              className="media-object"
              src={'/img/homeAssets/social-uiux.webp'}
            />
            <p className="instaUsername">
            ...
            <div className="instaFollow">
              <div className="instaFollowers">
                <span className="no">2.5M </span>
                <br></br>
                <span className="txt">followers</span>
              </div>
              <div className="instaFollowing">
                <span className="no">1.3k </span>
                <br></br>
                <span className="txt">posts</span>
              </div>
            </div>
      ...
      <li className="col-md-2">
        <a href="https://www.instagram.com/wireflow/" target="_blank">
          <div className="socialCardInner socialBoxReveal">
            <img
              className="media-object"
              src={'/img/homeAssets/social-wireflow.webp'}
            />
            <p className="instaUsername">
            ...
            <div className="instaFollow">
              <div className="instaFollowers">
                <span className="no">29.9k </span>
                <br></br>
                <span className="txt">followers</span>
              </div>
              <div className="instaFollowing">
                <span className="no">282 </span>
                <br></br>
                <span className="txt">posts</span>
              </div>
            </div>
      ...
      <li className="col-md-2">
        <a href="https://www.instagram.com/ux_store/" target="_blank">
          <div className="socialCardInner socialBoxReveal">
            <img
              className="media-object"
              src={'/img/homeAssets/social-uxstore.jpg'}
            />
            <p className="instaUsername">
              <strong>UX_STORE</strong>
            </p>
            <p className="instaDescription">UX Design Tools - UX Store</p>
            <div className="instaFollow">
              <div className="instaFollowers">
                <span className="no">20.2k </span>
                <br></br>
                <span className="txt">followers</span>
              </div>
              <div className="instaFollowing">
                <span className="no">118 </span>
                <br></br>
                <span className="txt">posts</span>
              </div>
            </div>
      ...
      <li className="col-md-2">
        <a href="https://www.instagram.com/vanila.io/" target="_blank">
          <div className="socialCardInner socialBoxReveal">
            <img
              className="media-object"
              src={'/img/homeAssets/social-vanilaio.webp'}
            />
            <p className="instaUsername">

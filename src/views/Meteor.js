            ...
            <SEO url="meteor" />
              <div id="zoomScale" className="headerIntro">
                ...
                <div className="container">
                  ...
                  <div className="col-md-5"><img className="enterRight-header" src={('../img/homeAssets/meteor-graphics.webp')} /></div>
                </div>
                </div>
              </div>
              <div className="aboutAppDev">
                <div className="container">
                  ...
                  <div className="col-md-6 aboutAppDev-img"><img className="enterRight-dev" src={('../img/homeAssets/partner-logo.webp')} /></div>
                </div>
                </div>
                  ...
                  <div className="container">
                      ...
                      <div className="row">
                          <div className="col-md-4">
                              <img src={('../img/homeAssets/Galaxy.webp')} alt="Hybrid mobile apps" />
                          ...
                          <div className="col-md-4">
                              <img src={('../img/homeAssets/iPhone.webp')} alt="Native mobile apps" className="imgIphone" />
                          ...
                          <div className="col-md-4">
                              <img src={('../img/homeAssets/DBinterface-flat.webp')} alt="Fast turnaround time" />
                          ...
                          <div className="col-md-4">
                              <img src={('../img/homeAssets/Rocket.webp')} alt="Hybrid mobile apps" />
                              <h3>Hot deploys</h3>
                          ...
                          <div className="col-md-4">
                              <img src={('../img/homeAssets/Browserscript.webp')} alt="Native mobile apps" />
                          ...
                          <div className="col-md-4">
                              <img src={('../img/homeAssets/USBcable.webp')} alt="Fast turnaround time" />

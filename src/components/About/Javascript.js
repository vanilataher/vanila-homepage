    ...
    return (
      <div className="aboutJavascript">
        ...
        <div className="container">
          <div className="col-md-6 aboutJavascript-img onlyDesktop"><img className="enterLeft-js" src={'../../img/homeAssets/js-dev.png'} /></div>
          ...
          <div className="col-md-6 aboutJavascript-img onlyMobile"><img className="enterLeft-js" src={'../../img/homeAssets/js-dev.png'} /></div>
        </div>
        </div>
      </div>
    );

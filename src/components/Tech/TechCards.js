...
const TechCards = (props) => {
  ...
  const techDetails = [
    {
        logo: ('../../img/homeAssets/meteor.png'),
        title: 'Meteor.js',
    ...
    {
        logo: ('../../img/homeAssets/graphql.png'),
        title: 'GraphQL',
    ...
    {
        logo: ('../../img/homeAssets/react-native.png'),
        title: 'React Native',
    ...
    {
        logo: ('../../img/homeAssets/angular.png'),
        title: 'Angular.js',
    ...
    return (
      ...
      <div className="techCardInner">
        <div className="media-left">
            <a href="#"><img className="media-object" src={techCard.logo}/></a>
        </div>
        <div className="media-body">
          <div className="media-heading"><strong>{techCard.title}</strong><br></br>
          <p>{techCard.description}</p></div>
          <div>
            <img className="techGithubLogo" src={('../../img/homeAssets/githubLogo.png')} /><br></br>
            <img src={('../../img/homeAssets/githubStar.png')} /><span className="githubStars">{techCard.githubStars + 'k'}</span>
          </div>
        </div>
        </div>
     </li>

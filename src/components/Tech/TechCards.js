    ...
    return (
      ...
      <div className="techCardInner">
        ...
        <div className="media-body">
          ...
          <div>
            <img className="techGithubLogo" src={('../../img/homeAssets/githubLogo.webp')} /><br></br>
            <img src={('../../img/homeAssets/githubStar.webp')} /><span className="githubStars">{techCard.githubStars + 'k'}</span>
          </div>
        </div>
        </div>
     </li>

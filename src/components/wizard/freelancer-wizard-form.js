        ...
        return (
            <div className="wizard-form row">
                ...
                <div className="col-md-12">
                    ...
                    <div className={this.getClass("container animated fadeInLeft", 2)}>
                        <div className="row">
                    ...
                    <div className={this.getClass("container animated fadeInLeft", 3)}>
                        <div className="row">
                    ...
                    <div className={this.getClass("container animated fadeInLeft", 4)}>
                        <div className="row">
                            <div className="form col-md-12">
                    ...
                    <div className={this.getClass("container animated fadeInLeft", 5)}>
                        <div className="row">

      ...
      <div className="row">
        <div  className="container">
          <div className="col-md-6 projectAutomatio">
            ...
            <img className="enterProjectLeft" src={('../../img/homeAssets/wekan.webp')}/>
          </div>
          <div className="col-md-6 projectWireflow">
            ...
            <img className="enterProjectRight" src={('../../img/homeAssets/wireflow.webp')}/>
          </div>
          <div className="col-md-12 projectWekan">
            <div className="col-md-8 onlyDesktop">
              <img  className="enterProjectBottom" src={('../../img/homeAssets/automatio.webp')}/>
            </div>
          ...
          <div className="col-md-12 projectMoonly">
            ...
            <div className="col-md-8">
              <img  className="enterProjectBottom" src={('../../img/homeAssets/moonly.webp')}/>
            </div>
          </div>
        </div>
      </div>
